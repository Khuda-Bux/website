    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('Sukkur', 'Buffalo'), ('Got', 'Sheep'), ('Other', 'Hen')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('M', 'Mobile'), ('L', 'Laptop'), ('C', 'cloth'), ('S', 'shoes')], max_length=10)),
